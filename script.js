...
function startTimer() {
  ...
  timer = 60;
  updateTimerStyle(); // Inicializa estilo
...
instructionsDiv.addEventListener('click', () => {
  if(instructionsDiv.querySelector('ul').style.display === 'none' || instructionsDiv.querySelector('ul').style.display === '') {
    document.getElementById('span1F783').setAttribute('hidden', 'hidden');
    instructionsDiv.querySelector('ul').setAttribute('style', 'display:inline');
  } else {
    document.getElementById('span1F783').removeAttribute('hidden');
    instructionsDiv.querySelector('ul').setAttribute('style', 'display:none');
  }
})
